...
import { SwapData } from '@onenesslabs/crosslightning-base';
...
export abstract class ISwap {
  ...
  protected constructor(pricingInfoOrObj: PriceInfoType | any) {
    if (
      pricingInfoOrObj.isValid != null &&
      pricingInfoOrObj.differencePPM != null
    ) {
      ...
      this.pricingInfo = {
        ...
        differencePPM:
          pricingInfoOrObj._differencePPM == null
            ? null
            : new BN(pricingInfoOrObj._differencePPM),
        satsBaseFee:
          pricingInfoOrObj._satsBaseFee == null
            ? null
            : new BN(pricingInfoOrObj._satsBaseFee),
        feePPM:
          pricingInfoOrObj._feePPM == null
            ? null
            : new BN(pricingInfoOrObj._feePPM),
      };
    }
  }
  ...
  getPriceDifferencePct(): number {
    return this.pricingInfo == null
      ? null
      : this.pricingInfo.differencePPM == null
      ? null
      : this.pricingInfo.differencePPM.toNumber() / 1000000;
  }
  ...
  serialize(): any {
    ...
    return {
      ...
      _differencePPM:
        this.pricingInfo.differencePPM == null
          ? null
          : this.pricingInfo.differencePPM.toString(10),
      _satsBaseFee:
        this.pricingInfo.satsBaseFee == null
          ? null
          : this.pricingInfo.satsBaseFee.toString(10),
      _feePPM:
        this.pricingInfo.feePPM == null
          ? null
          : this.pricingInfo.feePPM.toString(10),
    };
  }
