...
export class ToBTCLNSwap<T extends SwapData> extends IToBTCSwap<T> {
  ...
  constructor(
    ...
    if (typeof prOrObject === 'string') {
      ...
      this.routingFeeSats =
        prOrObject.routingFeeSats == null
          ? null
          : new BN(prOrObject.routingFeeSats);
  ...
  serialize(): any {
    ...
    partialSerialized.routingFeeSats =
      this.routingFeeSats == null ? null : this.routingFeeSats.toString(10);
